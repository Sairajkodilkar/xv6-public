...
int             allocuvm(pde_t*, struct proc_v2drive_map *, uint, uint, uint);
int             deallocuvm(pde_t*, struct proc_v2drive_map *, uint, uint);
void            freevm2(pde_t*, struct proc_v2drive_map *);
void            freevm(pde_t*);
